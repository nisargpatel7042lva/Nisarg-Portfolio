      ...
      <div className="space-y-8 md:space-y-12">
        ...
        >
          <div className="flex flex-col items-center space-y-6 md:flex-row md:space-y-0 md:space-x-8">
            <ParallaxSection speed={0.3} className="flex-shrink-0">
          ...
          {quickStats.map((stat, index) => (
            <ScrollReveal key={index} delay={index * 0.1}>
              <motion.div whileHover={{ scale: 1.05, y: -5 }} transition={{ duration: 0.3 }}>
                <Card className="bg-github-secondary border-github-border glass text-center h-full">
          ...
          <div className="github-card">
            ...
            <div className="flex justify-center md:justify-start gap-4">
              {socialLinks.map((social, index) => (
                <motion.div key={index} whileHover={{ scale: 1.1, y: -3 }} transition={{ duration: 0.2 }}>
                  <Button
                    variant="outline"
                    size="sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <ScrollReveal delay={0.1}>
              <motion.div whileHover={{ y: -8 }} transition={{ duration: 0.3 }}>
                <Card className="bg-github-secondary border-github-border glass h-full">
                    ...
                    <div className="flex flex-wrap gap-1.5 md:gap-2">
                      {languages.map((lang, i) => (
                        <motion.div
                          ...
                          viewport={{ once: true }}
                        >
                          <Badge variant="secondary" className="bg-github-dark text-github-accent border border-github-accent/30 text-xs">
                            {lang}
                          </Badge>
                        </motion.div>
                      ))}
